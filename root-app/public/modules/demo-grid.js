...
// module
exports.push([module.i, "td,th{min-width:120px;padding:10px 20px}th.active{color:#0085e4}th.active .arrow{opacity:1}.arrow{display:inline-block;vertical-align:middle;width:0;height:0;margin-left:5px;opacity:.66}.arrow.asc{border-bottom:4px solid #0085e4}.arrow.asc,.arrow.dsc{border-left:4px solid transparent;border-right:4px solid transparent}.arrow.dsc{border-top:4px solid #0085e4}", ""]);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"6f7c4720-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/App.vue?vue&type=template&id=6157d1eb&shadow
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('table',{staticClass:"highlight",attrs:{"v-if":_vm.mounted && _vm._columns}},[_c('thead',[_c('tr',_vm._l((_vm._columns),function(key){return _c('th',{key:key,class:{ active: _vm.sortKey == key },on:{"click":function($event){return _vm.sortBy(key)}}},[_vm._v("\n          "+_vm._s(_vm._f("capitalize")(key))+"\n          "),_c('span',{staticClass:"arrow",class:_vm.sortOrders[key] > 0 ? 'asc' : 'dsc'})])}),0)]),_c('tbody',_vm._l((_vm.filteredData),function(entry,i){return _c('tr',{key:i},_vm._l((_vm._columns),function(key){return _c('td',{key:key,on:{"click":function($event){return _vm.clickHandler(entry)}}},[_vm._v(_vm._s(entry[key]))])}),0)}),0)])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/App.vue?vue&type=template&id=6157d1eb&shadow
...
/* harmony default export */ var Appvue_type_script_lang_js_shadow = ({
  ...
  data: function data() {
    var sortOrders = {};
    (JSON.parse(this.columns) || []).forEach(function (key) {
      sortOrders[key] = 1;
    });
    return {
      sortKey: "",
      ...
      mounted: false,
      _columns: JSON.parse(this.columns)
    };
  },
  computed: {
  ...
  created() {
    this._columns = JSON.parse(this.columns);
  },
...
window.customElements.define('demo-grid', vue_wc_wrapper(external_Vue_default.a, Appshadow))
...
/******/ });
//# sourceMappingURL=demo-grid.js.map